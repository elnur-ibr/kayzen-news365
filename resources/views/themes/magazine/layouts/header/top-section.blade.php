...
<section
    ...
    <div class="container mx-auto py-2 flex justify-between items-center">
        ...
        <button onclick="openSidebar()" type="button"
            class="xl:hidden bg-neutral-100 dark:bg-neutral-600 text-neutral-600 dark:text-neutral-50 rounded-full w-9 h-9 flex justify-center items-center border dark:border-neutral-800">
        ...
        <section class="flex items-center gap-2 md:gap-4">
           ...
           <!-- Search Button -->
            <div class="xl:hidden">
                @include('themes.magazine.components.common.search-button')
            </div>
