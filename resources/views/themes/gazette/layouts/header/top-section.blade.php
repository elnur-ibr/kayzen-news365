<!-- Top Section -->
<section
    class="bg-white dark:bg-neutral-950 shadow-md top_header transition-all duration-500 z-20 ease-in dark:shadow-white/10 fixed xl:relative left-0 top-0 w-full">
    <div class="container mx-auto py-2 flex justify-between items-center">
        <!-- Left section -->

        <button onclick="openSidebar()" type="button"
            class="xl:hidden bg-neutral-100 dark:bg-neutral-600 text-neutral-600 dark:text-neutral-50 rounded-full w-9 h-9 flex justify-center items-center">
        ...
        <section class="flex items-center gap-2 md:gap-4">
            ...
            @if (app_setting()->web_user_can_login == 1)
                @include('themes.gazette.components.common.login-button')
            @endif
            ...
            <!-- Search button -->
            <div class="xl:hidden">
                @include('themes.gazette.components.common.search-button')
            </div>
