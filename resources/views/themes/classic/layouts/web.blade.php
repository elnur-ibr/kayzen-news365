...
<head>
	...
	<style>
	:root {
		@if ($principalFont) --font-principal: {
			 ! ! $principalFont->font_family ! !
		}

		;

		@endif @if ($alternateFont) --font-alternate: {
			 ! ! $alternateFont->font_family ! !
		}

		;

		@endif @if ($supplementaryFont) --font-supplementary: {
			 ! ! $supplementaryFont->font_family ! !
		}
