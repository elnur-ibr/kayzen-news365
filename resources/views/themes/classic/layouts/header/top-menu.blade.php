...
@endphp
<section class="@if (!$themeSettings->background_color || mode()) bg-black @endif hidden xl:block fixed_top_menu"
        ...
        <div class="hidden lg:block side-bar">
            <div class="menu flex items-center gap-2 xl:gap-4">
                <div class="item relative cursor-pointer py-2">
                    <a class="capitalize @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 side_nav"
                    ...
                    @if ($menu->submenus->isNotEmpty())
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url($menu->slug) }}"
                                class="sub-btn @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 hover:text-red-600 active:text-red-600 side_nav"
                ...
                <div class="item cursor-pointer py-2 relative">
                    <a class="sub-btn @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 hover:text-red-600 active:text-red-600 side_nav"
                                    ...
                                    <li class="py-2 isolate relative overflow-hidden inner_menu">
                                        ...
                                        <ul
                                            ...
                                            @foreach ($page->pagesubmenus as $submenu)
                                                ...
                                                <li class="py-2">
                                                    <a class="px-3 block hover:text-brand-primary transition_3 text-nowrap"
