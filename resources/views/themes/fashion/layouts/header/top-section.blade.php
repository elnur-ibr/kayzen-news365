<!-- Top Section -->
<section
    class="@if (!$themeSettings->background_color || mode()) bg-theme-six-primary @endif shadow-md top_header  transition-all duration-500 z-20 ease-in dark:shadow-white/10 fixed left-0 top-0 w-full xl:relative"
    ...
    <div class="container mx-auto py-2 flex justify-between items-center">
        ...
        <section class="flex items-center gap-2 md:gap-4">
            <!-- Login / Registration -->
            @include('themes.fashion.components.common.login-button')
            ...
            <!-- Search button -->
            <div class="xl:hidden">
                @include('themes.fashion.components.common.search-button')
            </div>
